...
`git clone https://github.com/ByteLegendQuest/java-create-instance-method`

A project directory named `java-create-instance-method` will be created, which can be moved wherever you like.

Open `IDEA`, `File` - `Open`, select and open the `pom.xml` in `java-create-instance-method` directory which is created just now.
